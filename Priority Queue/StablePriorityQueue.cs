...
namespace Priority_Queue {
    ...
    public sealed class StablePriorityQueue<T> : IFixedSizePriorityQueue<T, float>, IFixedSizePriorityQueue<T, int> where T : StablePriorityQueueNode {
        ...
        public bool Contains(T node) {
            ...
            if (node.QueueIndex < 0 || node.QueueIndex >= m_nodes.Length) throw new InvalidOperationException("node.QueueIndex has been corrupted. Did you change it manually?");
#endif
            #endregion
...
#endif
        #endregion
        private bool HasHigherPriority(T higher, T lower) => (higher.Priority < lower.Priority || (higher.Priority == lower.Priority && higher.InsertionIndex < lower.InsertionIndex));
